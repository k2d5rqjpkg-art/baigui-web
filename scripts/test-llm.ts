...
import { generateQuest, generateDialogue, isLlmAvailable, fallbackQuest, fallbackDialogue } from "../src/core/llm/index.js";
...
async function main(): Promise<void> {
  ...
  banner(llmAvailable ? "[LLM MODE] DEEPSEEK_API_KEY detected" : "[FALLBACK MODE] no DEEPSEEK_API_KEY — using static tables");
  ...
  for (const name of ["Old Hag Kiku", "Lantern-Bearer Shō", "Driftwood Taro", "Unknown Wanderer"] as const) {
