...
describe('distributeLoot (借鉴 WoC 战利品分配教训)', () => {
  it('legendary 给伤害最高者', () => {
    const loot: ItemTemplate[] = [
      { id: 'legendary-sword', name: 'Legendary Sword', slot: 'weapon', rarity: 'legendary',
  ...
  it('rare 随机分 (确定性 RNG)', () => {
    const loot: ItemTemplate[] = [
      { id: 'rare-ring', name: 'Rare Ring', slot: 'accessory', rarity: 'rare',
  ...
  it('epic 给第一个参与者', () => {
    const loot: ItemTemplate[] = [
      { id: 'epic-shield', name: 'Epic Shield', slot: 'armor', rarity: 'epic',
  ...
  it('无参与者 → loot 进 unassigned (借鉴 WoC 的崩溃教训)', () => {
    const loot: ItemTemplate[] = [
      { id: 'common-sword', name: 'Common Sword', slot: 'weapon', rarity: 'common',
  ...
  it('多种 rarity 排序: legendary > epic > rare > common', () => {
    const loot: ItemTemplate[] = [
      { id: 'common', name: 'Common', slot: 'weapon', rarity: 'common', affixes: [{ key: 'atk', value: 1 }] },
      { id: 'rare', name: 'Rare', slot: 'weapon', rarity: 'rare', affixes: [{ key: 'atk', value: 5 }] },
      { id: 'epic', name: 'Epic', slot: 'weapon', rarity: 'epic', affixes: [{ key: 'atk', value: 15 }] },
      { id: 'legendary', name: 'Leg', slot: 'weapon', rarity: 'legendary', affixes: [{ key: 'atk', value: 50 }] },
    ];
