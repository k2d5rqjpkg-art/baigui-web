...
export const QUEST_POOL: QuestTemplate[] = [
  ...
  },
  {
    ...
    levelMax: 6,
    baseHint: '采集铁矿',
    rewardTemplate: '70 金 + 锻造材料',
  },
  {
    id: 'q-mountain-hermit',
    kind: 'talk',
    target: 'npc',
    count: 1,
    biome: 'mountain',
  ...
  },
  {
    ...
    levelMax: 4,
    baseHint: '渔夫委托',
    rewardTemplate: '30 金 + 新鱼获',
  },
  {
    id: 'q-coast-lighthouse',
    kind: 'explore',
    target: 'area',
    count: 1,
    biome: 'coast',
 ...
 */
export function expandQuest(template: QuestTemplate, level: number, apiKey?: string): QuestJson {
  // LLM 装饰 (失败 fallback)
  let title: string;
